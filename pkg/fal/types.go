...
// GrokImagineVideoOptions represents options for grok-imagine-video
type GrokImagineVideoOptions struct {
	Duration    int    `json:"duration"`     // 1-15 seconds
	AspectRatio string `json:"aspect_ratio"` // auto, 16:9, 4:3, 3:2, 1:1, 2:3, 3:4, 9:16
	Resolution  string `json:"resolution"`   // 480p, 720p
}

// GetDefaultValues returns default values for Grok Imagine Video options
func (o *GrokImagineVideoOptions) GetDefaultValues() map[string]interface{} {
	return map[string]interface{}{
		"duration":     6,
		"aspect_ratio": "auto",
		"resolution":   "720p",
...
// Validate validates the Grok Imagine Video options
func (o *GrokImagineVideoOptions) Validate() error {
	if o.Duration != 0 && (o.Duration < 1 || o.Duration > 15) {
		return fmt.Errorf("invalid duration: %d (must be between 1 and 15)", o.Duration)
	}
	validAspectRatios := map[string]bool{
		"auto": true, "16:9": true, "4:3": true, "3:2": true,
		"1:1": true, "2:3": true, "3:4": true, "9:16": true, "": true,
	}
	if !validAspectRatios[o.AspectRatio] {
		return fmt.Errorf("invalid aspect_ratio: %s (must be auto, 16:9, 4:3, 3:2, 1:1, 2:3, 3:4, or 9:16)", o.AspectRatio)
	}
...
// GrokImagineVideoRequest represents a request for grok-imagine-video
