module github.com/karamble/braibot
...
require github.com/karamble/brmcp v0.0.0-20260702114223-9e315d4b19a7
...
require (
	...
	github.com/decred/dcrlnd v0.8.2-0.20260504180059-d11b48570880 // indirect
